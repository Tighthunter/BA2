...
static struct FScriptStruct_SpeechRecognition_StaticRegisterNativesFRecognisedPhrases
{
	...
	IMPLEMENT_CLASS(ASpeechRecognitionActor, 3744112996);
...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_SpeechRecognition_EPhraseRecognitionTolerance()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_1")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_2")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_3")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_4")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_5")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_6")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_7")), 6));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_8")), 7));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_9")), 8));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_10")), 9));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPhraseRecognitionTolerance::VE_MAX")), 10));
	...
	uint32 Get_Z_Construct_UEnum_SpeechRecognition_EPhraseRecognitionTolerance_CRC() { return 1567113724U; }
	UEnum* Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionLanguage()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionLanguage::VE_English")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionLanguage::VE_Chinese")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionLanguage::VE_French")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionLanguage::VE_Spanish")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionLanguage::VE_Russian")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionLanguage::VE_MAX")), 5));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionLanguage_CRC() { return 1370750505U; }
	UEnum* Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionParamType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionParamType::VE_FLOAT")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionParamType::VE_BOOLEAN")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionParamType::VE_STRING")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionParamType::VE_INTEGER")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionParamType::VE_MAX")), 4));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionParamType_CRC() { return 2682070849U; }
	UEnum* Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionMode::VE_KEYWORD")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionMode::VE_GRAMMAR")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionMode::VE_LANGUAGE_MODEL")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechRecognitionMode::VE_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionMode_CRC() { return 157848220U; }
